...
//     version 1.11.2
//     from Assets/MenuInputs.inputactions
//
...
public partial class @MenuInputs: IInputActionCollection2, IDisposable
{
    ...
    ~@MenuInputs()
    {
        UnityEngine.Debug.Assert(!m_MenuNavigation.enabled, "This will cause a leak and performance issues, MenuInputs.MenuNavigation.Disable() has not been called.");
    }
    ...
    public struct MenuNavigationActions
    {
        ...
        public MenuNavigationActions(@MenuInputs wrapper) { m_Wrapper = wrapper; }
